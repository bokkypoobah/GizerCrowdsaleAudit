...
addAccount(eth.accounts[11], "Account #11 - Redemption Wallet");
...
var redemptionWallet = eth.accounts[11];
...
function printTokenContractDetails() {
  ...
  if (tokenContractAddress != null && tokenContractAbi != null) {
    ...
    console.log("RESULT: token.tokensBurnedTotal=" + contract.tokensBurnedTotal().shift(-decimals));

    console.log("RESULT: token.presaleContributorCount=" + contract.presaleContributorCount());

    console.log("RESULT: token.tokensFrozen=" + contract.tokensFrozen());
    ...
    var ownerTokensBurnedEvents = contract.OwnerTokensBurned({}, { fromBlock: tokenFromBlock, toBlock: latestBlock });
    i = 0;
    ownerTokensBurnedEvents.watch(function (error, result) {
      console.log("RESULT: OwnerTokensBurned " + i++ + " #" + result.blockNumber + " " + JSON.stringify(result.args));
    });
    ownerTokensBurnedEvents.stopWatching();
